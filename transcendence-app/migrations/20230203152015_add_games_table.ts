  ...
  return knex.raw(`
    CREATE TABLE
        IF NOT EXISTS Game (
            ...
            "playerOneUsername" VARCHAR(20) NOT NULL REFERENCES Users (username) ON UPDATE CASCADE,
            "playerTwoUsername" VARCHAR(20) NOT NULL REFERENCES Users (username) ON UPDATE CASCADE,
